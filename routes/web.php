...
Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
	// Email verification custom (harus di dalam prefix locale agar /id/email/verify/... bisa diakses)
	Route::post('email/resend', [\App\Http\Controllers\Auth\ResendVerificationController::class, 'resend'])->name('verification.resend');
	Route::get('email/verify/{token}', [\App\Http\Controllers\Auth\ResendVerificationController::class, 'verify'])->name('verification.verify');
