...
<?php $component->withAttributes([]); ?>
  <?php $__env->slot('title', __('Register')); ?>
...
<?php endif; ?>
    ...
    <div class="authentication-inner row m-0">
      <?php $alert = session('alert') ?? old('alert'); ?>
      <?php if($alert): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
        <?php $__env->slot('type', $alert['type']); ?>
        <?php $__env->slot('msg', $alert['msg']); ?>
...
<?php endif; ?>
      ...
      <div class="d-none d-xl-flex col-xl-8 p-0">
        <div class="auth-cover-bg d-flex justify-content-center align-items-center">
          <img
            src="<?php echo e(asset('img/illustrations/auth-register-illustration-light.png')); ?>"
      ...
      <div class="d-flex col-12 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
        <div class="w-px-400 mx-auto mt-12 pt-5 position-relative">
          ...
          <form id="formAuthentication" class="mb-6" action="<?php echo e(route('register')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6 form-control-validation">
              ...
              <input type="text" class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" id="email" name="email" placeholder="<?php echo e(__('email')); ?>" />
              <p class="text-danger">
...
unset($__errorArgs, $__bag); ?>
          ...
          <p class="text-center">
            <span><?php echo e(__('Already have account?')); ?></span>
            <a href="<?php echo e(route('login')); ?>">
              <span><?php echo e(__('Sign in here')); ?></span>
            </a>
          </p>
        </div>
      </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\mpwa_v10\resources\themes/vuexy/views/auth/register.blade.php ENDPATH**/ ?>